...
fermis = 1e-3*e*linspace(1,50,numfermis);
B =0; %tesla
...
T0_end = inv(T_0new);
lnew =Tl*[C1l,C2l;zeros(Ny),eye(Ny)]*[eye(Ny),zeros(Ny);P1l,P2l];
propagating_speeds_in = hbar*log(sortedvalues(1:forwardmodes))/(1j*mstar_gaas);
...
% eig and sorts them into forward propagating, forward decaying,
% back propagating and back evanescent.
[sortedvaluesout,sortedvectorsout,ignorethis] = sort_eig(somevectorsout,somevaluesout);
